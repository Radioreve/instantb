...
var Marislider = (function () {
  ...
  function setBullets(slider_id) {
    ...
    var bullets_content = ['<div class="marislider-bullets x--content">']
  ...
  function init() {
    ...
    $('.marislider').each(function (i, marislider) {
      ...
      var w = $(marislider).attr('waves') != undefined ? true : false;
      var o = $(marislider).attr('overlay') != undefined ? true : false;
